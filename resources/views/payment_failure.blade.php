...
<body>
    <section class="success">
        ...
        <h1>Payment Failed<span class="bx bxs-x-circle"></span></h1>
        <h3>We're sorry, but the payment could not be processed at the moment.<br> Please try again later or contact our support team for assistance.</h3>
