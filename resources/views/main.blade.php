    ...
    <nav class="cart-mobile-navigation-menu has-scrollbar " cart-mobile-menu>
      ...
      <div class="cart-foot">
        ...
        <form action="/session" method="POST" id="form">
          ...
          <button class="btn btn-success" type="submit" id="co" ><i class="fa fa-money style="display:none"></i> pay now</button>
            ...
            <div class="box" id="box">
              ...
              <form action="{{ route('main') }}" method="POST" enctype="multipart/form-data">
                ...
                <form action="{{ route('main.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <form action="{{ route('profileShow') }}" method="GET" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="box-mid">
                          <div class="form-item">
                              ...
                              <input id="input" type="text" class="input" placeholder="Username" name="username3" value="{{ $username }}" required>
                          </div><br>
                          <div class="form-item">
                              <div class="field">
                                  <label class="label" for="email">Email</label><br>
                              </div>   
                              <input id="input" type="email" class="input" placeholder="Email" name="email3" value="{{ $email }}" required>
                          </div><br>
                          @if (session('success'))
                      ...
                      <div class="box-lower">
                          <button id="bu" type="submit" data-route="{{ route('main.update') }}" >Save</button>
                      </div>
